...
| System         | Type           | Input          |  Output        | Source code     | Code           | 
| :------------ |:--------------- |:---------------|:---------------| :---------------|:---------------|
...
| question-answering system |user interface| natural language question (auto-completion)| answer from RDF Data |[github](https://github.com/ag-sc/QueGG-web/tree/extension)|
